 ...
 * @property {ArrayStruct} get the Struct that describes an Array of this Type
 */
class Type {
    /**
...
class Struct extends Type {
     ...
     *
     * @property sizeOffset {number} offset containing the size of the field being added by addField
     * <p>Example :</p>
     * <pre>
...
class StructPointer extends Type {
    ...
    read(memory, address, opts) {
        ...
        if (opts && 'sizeOffset' in opts) {
            opts.sizePointer = address + Struct.PTR_SIZE;
            // don't delete sizePointer because other instances of this StructPointer may need it
        }
...
class ArrayStruct extends Struct {
    ...
    read(memory, address, opts) {
        ...
        if (!object) {
            ...
            const sizePointer = (opts && 'sizePointer' in opts) ? opts.sizePointer : undefined;
            if (opts) {
                delete opts.sizePointer;
            }
            const getSize = () => Type.int.read(memory, sizePointer);
