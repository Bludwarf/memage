...
const ResourcesStatePointer = new StructPointer(ResourcesState);

const ResourceStateParent = new Struct('ResourceStateParent')
    .addField(ResourcesState.pointer, 'resourcesState', 0x3C);

const ResourceStateParentParent = new Struct('ResourceStateParentParent')
    .addField(ResourceStateParent.pointer, 'resourcesStateParent', 0x134);
